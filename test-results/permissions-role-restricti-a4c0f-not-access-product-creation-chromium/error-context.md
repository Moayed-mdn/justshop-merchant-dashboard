...
- Name: permissions/role-restrictions.spec.ts >> role without product.create cannot access product creation
- Location: tests/e2e/permissions/role-restrictions.spec.ts:46:5
