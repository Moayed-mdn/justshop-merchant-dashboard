...
- Name: tenancy/onboarding.spec.ts >> successful first store creation completes onboarding and grants dashboard access
- Location: tests/e2e/tenancy/onboarding.spec.ts:21:5
