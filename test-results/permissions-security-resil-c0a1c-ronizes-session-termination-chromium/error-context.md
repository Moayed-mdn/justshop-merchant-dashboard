...
- Name: permissions/security-resilience.spec.ts >> cross-tab logout synchronizes session termination
- Location: tests/e2e/permissions/security-resilience.spec.ts:29:5
