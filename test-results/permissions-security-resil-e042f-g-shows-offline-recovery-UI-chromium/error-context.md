...
- Name: permissions/security-resilience.spec.ts >> network interruption during provisioning shows offline recovery UI
- Location: tests/e2e/permissions/security-resilience.spec.ts:48:5
