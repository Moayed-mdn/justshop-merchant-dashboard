...
- Name: permissions/role-restrictions.spec.ts >> role without order.manage cannot update order status
- Location: tests/e2e/permissions/role-restrictions.spec.ts:72:5
