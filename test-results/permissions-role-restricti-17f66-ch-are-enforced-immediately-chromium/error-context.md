...
- Name: permissions/role-restrictions.spec.ts >> permission changes after store switch are enforced immediately
- Location: tests/e2e/permissions/role-restrictions.spec.ts:132:5
