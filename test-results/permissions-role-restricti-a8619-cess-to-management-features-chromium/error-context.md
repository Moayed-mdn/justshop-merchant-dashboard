...
- Name: permissions/role-restrictions.spec.ts >> limited role restricts access to management features
- Location: tests/e2e/permissions/role-restrictions.spec.ts:33:5
