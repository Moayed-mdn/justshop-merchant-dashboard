...
- Name: permissions/role-restrictions.spec.ts >> role without user.view cannot access user management
- Location: tests/e2e/permissions/role-restrictions.spec.ts:107:5
